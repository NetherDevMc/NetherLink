...
class HowToDialogs {
  ...
  static Future<void> showNintendoInstructions(
    ...
    return _showDialog(
      ...
      steps: [loc.playInstructionsSwitch(relayName ?? '-', relayIp ?? '-')],
    );
  }
  ...
  static Future<void> showFriendsInstructions(
    ...
    return _showDialog(
      ...
      steps: [loc.playInstructionsFriends(friendName ?? '-')],
    );
  }
