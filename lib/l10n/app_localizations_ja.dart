...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get javaInfoText => 'Java Edition サーバーに接続';

  @override
  String get howToJavaTitle => 'Javaモード';

  @override
  String get howToJavaSubtitle => 'NetherLink 経由で Java Edition サーバーに接続';

  @override
  String get howToJavaBody => 'Javaモード — クイック手順:\r\n1. アプリで Java モードを選択します。\r\n2. Java Edition サーバーのアドレスとポートを入力します（デフォルト: 25565）。\r\n3. \"Javaモードを開始\" を押します — NetherLink が接続を中継します。\r\n4. Minecraft Bedrock を開き、Friends タブに移動します。\r\n5. \"NetherLink\" という名前の LAN サーバーを選択して Java サーバーに参加します。\r\n\r\n⚠️ 重要な警告:\r\n- 有効な Java Edition アカウント（Microsoft）が必要です。\r\n- 一部のサーバーではアンチチートシステムにより、アカウントが検出されて BAN される可能性があります。\r\n- Bedrock クライアントを明示的に禁止しているサーバーもあります。必ずサーバーのルールを確認してください。\r\n- この機能の利用により発生するアカウントの BAN、停止、その他のアカウント関連の問題について、NetherLink は責任を負いません。\r\n- 自己責任で使用してください。';
  ...
  @override
  String get bedrockBridge => 'Bedrock ブリッジ';
  ...
  String playInstructionsFriends(Object friend) {
    return '接続方法:\r\n1. コンソールで $friend をフレンドとして追加します。\r\n2. Minecraft を開き、フレンドタブに移動します。\r\n3. LAN ワールドの下にある自分のサーバーを探し、選択して参加します。';
  }
  ...
  @override
  String get startFriendsMode => 'フレンドモード開始';
  ...
  @override
  String get friendModeText => 'NetherLink のフレンド bot をフレンドとして追加します。フレンドモードを開始して遊びましょう';
