...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get javaInfoText => 'Java Edition سرورز سے جڑیں';

  @override
  String get howToJavaTitle => 'جاوا موڈ';

  @override
  String get howToJavaSubtitle => 'NetherLink کے ذریعے Java Edition سرورز سے جڑیں';

  @override
  String get howToJavaBody => 'جاوا موڈ — فوری مراحل:\r\n1. ایپ میں جاوا موڈ منتخب کریں۔\r\n2. اپنے Java Edition سرور کا ایڈریس اور پورٹ درج کریں (ڈیفالٹ: 25565)۔\r\n3. \"جاوا موڈ شروع کریں\" دبائیں — NetherLink کنکشن کو جوڑ دے گا۔\r\n4. Minecraft Bedrock کھولیں اور Friends ٹیب پر جائیں۔\r\n5. Java سرور سے جڑنے کے لیے \"NetherLink\" نامی LAN سرور منتخب کریں۔\r\n\r\n⚠️ اہم انتباہات:\r\n- ایک درست Java Edition اکاؤنٹ (Microsoft) درکار ہے۔\r\n- کچھ سرورز اینٹی چیٹ سسٹمز استعمال کرتے ہیں جو آپ کے اکاؤنٹ کا پتا لگا کر اسے بین کر سکتے ہیں۔\r\n- کچھ سرورز Bedrock کلائنٹس کو واضح طور پر منع کرتے ہیں — ہمیشہ سرور کے قواعد دیکھیں۔\r\n- اس فیچر کے استعمال سے پیدا ہونے والی کسی بھی اکاؤنٹ پابندی، معطلی یا اکاؤنٹ سے متعلق دیگر مسائل کے لیے NetherLink ذمہ دار نہیں ہے۔\r\n- اسے اپنی ذمہ داری پر استعمال کریں۔';
  ...
  @override
  String get nldServerLabel => 'NETHERLINK سرور';
